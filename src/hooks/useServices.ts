...
const INITIAL_SERVICES: Service[] = [
  {
    ...
    description: 'Pronto atendimento estruturado para casos críticos, traumas, exames rápidos e estabilização imediata.',
        image_url: 'https://images.pexels.com/photos/6235231/pexels-photo-6235231.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    icon: 'ShieldAlert',
    highlight: '24 Horas',
    active: true,
    order: 1
  },
  {
    ...
    description: 'Acompanhamento preventivo e tratamentos em Dermatologia, Cardiologia, Oftalmologia, Nefrologia e Oncologia.',
        image_url: 'https://images.pexels.com/photos/5998473/pexels-photo-5998473.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    icon: 'Stethoscope',
  ...
  },
  {
    ...
    description: 'Bloco cirúrgico moderno equipado com anestesia inalatória, monitorização multiparamétrica e UTI pós-operatória.',
        image_url: 'https://images.pexels.com/photos/7470754/pexels-photo-7470754.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    icon: 'Activity',
  ...
  },
  {
    ...
    description: 'Protocolos de vacinação essenciais e importados para cães e gatos, garantindo máxima imunidade e proteção.',
        image_url: 'https://images.pexels.com/photos/6235022/pexels-photo-6235022.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    icon: 'ShieldCheck',
    highlight: 'Prevenção',
    active: true,
    order: 4
  },
  {
    ...
    description: 'Laboratório próprio e diagnóstico por imagem digital para resultados rápidos e confiáveis no mesmo dia.',
        image_url: 'https://images.pexels.com/photos/3786157/pexels-photo-3786157.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    icon: 'Microscope',
  ...
  },
  {
    ...
    description: 'Diagnóstico por imagem não invasivo de alta precisão para avaliação detalhada abdominal, torácica e gestacional.',
        image_url: 'https://images.pexels.com/photos/5998465/pexels-photo-5998465.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&fit=crop',
    icon: 'HeartPulse',
